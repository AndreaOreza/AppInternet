...
public static b4a.example.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"Actualizar",Debug.moduleToString(b4a.example.actualizar.class),"hc",httputils2service._hc,"Main",Debug.moduleToString(b4a.example.main.class),"Receiver",httputils2service.mostCurrent._receiver,"Registro",Debug.moduleToString(b4a.example.registro.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder,"UpdatePass",Debug.moduleToString(b4a.example.updatepass.class),"Welcome",Debug.moduleToString(b4a.example.welcome.class)};
}
}