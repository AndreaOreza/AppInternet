...
public static b4a.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Actualizar",Debug.moduleToString(b4a.example.actualizar.class),"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"Main",Debug.moduleToString(b4a.example.main.class),"Registro",Debug.moduleToString(b4a.example.registro.class),"Service",starter.mostCurrent._service,"UpdatePass",Debug.moduleToString(b4a.example.updatepass.class),"Welcome",Debug.moduleToString(b4a.example.welcome.class)};
}
}